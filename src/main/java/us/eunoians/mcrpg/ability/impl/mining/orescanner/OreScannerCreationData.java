...
public class OreScannerCreationData extends AbilityCreationData implements TierableCreationData, ToggleableCreationData, UnlockableCreationData{
    ...
    public OreScannerCreationData(@NotNull AbilityHolder abilityHolder, @NotNull JsonObject jsonObject) {
