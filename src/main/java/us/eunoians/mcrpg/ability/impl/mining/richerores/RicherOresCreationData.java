...
/**
 * This class serves as a way to create {@link RicherOres}
 *
 * @author DiamondDagger590
 */
public class RicherOresCreationData extends AbilityCreationData implements TierableCreationData, ToggleableCreationData, UnlockableCreationData {
    ...
    public RicherOresCreationData(@NotNull AbilityHolder abilityHolder, @NotNull JsonObject jsonObject) {
